...
class OverloadRegistry:
    ...
    def _make_key(self, fn, args=None):
        ...
        return (fn.__module__, fn.__name__, len(args)) # key = {module, name, number of arguments} this helps us differentiate functions in overloading based on parameters
